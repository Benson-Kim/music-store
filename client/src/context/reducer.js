export const actionType = {
	...
	SET_LANG_FILTER: "SET_LANG_FILTER",
};
...
const reducer = (state, action) => {
	switch (action.type) {
		...
		case actionType.SET_ALBUM_FILTER:
			return { ...state, albumFilter: action.albumFilter };
		case actionType.SET_ARTIST_FILTER:
			return { ...state, artistFilter: action.artistFilter };
		case actionType.SET_LANG_FILTER:
